...
public class AluguelService {
    ...
    public Optional<Aluguel> findAlugueisById(Long id) {
        return Optional.ofNullable(this.aluguelRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Aluguel não encontratdo")));
    }
    ...
    private Aluguel calculaAluguel(AluguelRequestDTO aluguelRequestDTO){
        ...
        var quantidadeDia = BigDecimal.valueOf(aluguelRequestDTO.dataFim().getDayOfYear()-aluguelRequestDTO.dataInicio().getDayOfYear());
        var valor = veiculo.getValorDiaria().multiply(quantidadeDia);
